...
// =====================================================
// CREAR PANEL DE BÚSQUEDA GLOBAL
// =====================================================

function obtenerContenedorBusquedaGlobal() {
...
function mostrarOpcionBusquedaGlobal() {

    const contenedor =
        obtenerContenedorBusquedaGlobal();
    ...
    contenedor.innerHTML = `
        ...
        >
            ...
            🔎 Buscar en otras tiendas de tu zona
    ...
    if (boton) {
        ...
        boton.addEventListener(
            ...
            async () => {
                ...
                await buscarProductoEnOtrasTiendas();
...
async function buscarProductoEnOtrasTiendas() {
    ...
    try {
        ...
        console.log(
            "🔎 Inventarios consultados para búsqueda global:",
            inventariosGlobales.length
        );
        ...
        contenedor.innerHTML = `
            ...
            <div
                ...
                "
            >
                No pudimos buscar en otras tiendas.
                Intenta nuevamente.
            </div>
...
function mostrarSinResultadosGlobales() {
