...
const roads=[];vertical.forEach(x=>roads.push({x:x-world.roadW/2,y:0,w:world.roadW,h:world.h,type:"v"}));horizontal.forEach(y=>roads.push({x:0,y:y-world.roadW/2,w:world.w,h:world.roadW,type:"h"}));
...
function hitsBuilding(x,y,r=14){
  return buildings.some(b=>x>b.x-r&&x<b.x+b.w+r&&y>b.y-r&&y<b.y+b.h+r);
}
function generate(){
...
generate();
return{world,vertical,horizontal,roads,buildings,trees,shops,houses,isRoad,hitsBuilding};
})();
